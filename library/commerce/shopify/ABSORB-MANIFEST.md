...
These four corrections were applied after the initial reprint and verified end-to-end against the live Omnidesk Shopify store. They must persist across future reprints; generators should produce code matching these specs, not regenerate the broken originals.
